...
dir="~/work/Metazoa_holocentrism/repeatmasker/result/lepidoptera/top5LINESINE.tsv"
...
write.table(res,paste(outputdir,"bts_top5LINESINE.tsv",sep="/"),quote=F, sep='\t',row.names=F)
