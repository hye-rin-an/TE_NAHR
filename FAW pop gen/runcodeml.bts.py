...
import io
import shutil
directory='/home/work/han/Metazoa_holocentrism/FAW_BAW/dnds/bts_resampling'
ch=""
for subdir, dirs, files in os.walk(directory):
    for filename in files:
        if re.search("boot",filename):
            ...
            script="module load bioinfo/PAML/4.10.6 && cd /home/work/han/Metazoa_holocentrism/FAW_BAW/dnds/bts_resampling/"+x+" && codeml /home/work/han/Metazoa_holocentrism/FAW_BAW/dnds/script/1000codeml.ctl"
            os.system(script)
